...
const target = `      <div className="neo-card p-4 sm:p-6 w-full overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-7 gap-3 mb-6 items-stretch">
        <div className="neo-box p-3 sm:p-4 flex flex-col justify-center xl:col-span-2 bg-blue-50/10">
          <span className="text-[10px] text-gray-500 uppercase font-bold block mb-1">Pendapatan Bersih 1</span>
          <span className="font-black text-blue-custom text-sm sm:text-lg">Rp {formatRp(pendapatanBersihUtama)}</span>
          <span className="text-[9px] text-muted font-bold mt-1">Margin Utama + Insentif</span>
        </div>
        <div className="neo-box p-3 sm:p-4 flex flex-col justify-center xl:col-span-2 bg-green-50/10">
          <span className="text-[10px] text-gray-500 uppercase font-bold block mb-1">Pendapatan Bersih 2</span>
          <span className="font-black text-green-custom text-sm sm:text-lg">Rp {formatRp(pendapatanBersihKoperasi)}</span>
          <span className="text-[9px] text-muted font-bold mt-1">Margin Koperasi + Insentif (Tanpa Yayasan)</span>
        </div>
        <div className="neo-box p-3 sm:p-4 flex flex-col justify-center xl:col-span-3 bg-amber-50/30 border-l-4 border-amber-500">
          <span className="text-[10px] text-gray-500 uppercase font-bold block mb-3">Kalkulator Bagi Hasil (Berdasarkan Pendapatan Bersih 2)</span>
          <div className="flex items-center gap-4">
            <div className="flex items-center">
              <input 
                ...
                className="w-16 p-2 text-sm sm:text-base font-black text-center border-2 border-black/10 rounded-xl focus:outline-none focus:border-amber-500 bg-white shadow-inner transition-colors"
                min="0"
                max="100"
              />
              <span className="ml-1.5 font-black text-gray-600">%</span>
            </div>
            <div className="flex-1 flex flex-col border-l border-black/10 pl-4">
              <span className="text-[9px] text-muted font-bold mb-0.5">Hasil Pembagian:</span>
              <span className="font-black text-amber-600 text-sm sm:text-xl leading-none">
...
const replacement = `      <div className="neo-card p-4 sm:p-6 w-full overflow-hidden mb-6">
        <h3 className="font-extrabold text-blue-custom text-sm sm:text-lg mb-4 text-center sm:text-left uppercase">TOTAL REKAP SEMUA DAPUR</h3>
